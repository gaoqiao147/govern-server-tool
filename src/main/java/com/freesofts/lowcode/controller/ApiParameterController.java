...
public class ApiParameterController {
    @Resource
    ApiParameterService apiParameterService;

    @PostMapping("/save-a-data")
    @LogAnnotation(module = "新增")
    @ApiOperation(value = "新增一条数据源信息", httpMethod = "POST")
    public BizResponseData<?> saveParameter(@ApiParam(value = "apiParameter") @RequestBody ApiParameter apiParameter) {
        int result = apiParameterService.saveAParam(apiParameter);
    ...
    public BizResponseData<?> saveParameter(@ApiParam(value = "List<ApiParameter>") @RequestBody List<ApiParameter> list) {
        int result = apiParameterService.saveParams(list);
    ...
    public BizResponseData<?> getAllData() {
        List list = apiParameterService.getAll();
    ...
    public BizResponseData<?> updateData(
            ...
            @ApiParam(value = "数据对象") @RequestBody @Validated ApiParameter apiParameter
    ) {
        int result = apiParameterService.updateById(id, apiParameter);
        return IntegerBizResult.builder().value(result).build().beEqualTo(1);
    }
    ...
    public BizResponseData<?> deleteDataById(@ApiParam(value = "参数信息") String id) {
        int result = apiParameterService.deleteById(id);
        return IntegerBizResult.builder().value(result).build().greaterThan(-1);
    }
    ...
    public BizResponseData<?> deleteDataByIds(@ApiParam("参数信息") List<String> ids) {
        int result = apiParameterService.deleteByIds(ids);
        return IntegerBizResult.builder().value(result).build().greaterThan(-1);
    }
}
